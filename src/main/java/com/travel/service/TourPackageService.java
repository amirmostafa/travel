...
public class TourPackageService {
    ...
    /**
     * Get all the tourPackages.
     *
     * @param pageable the pagination information.
     * @return the list of entities.
     */
    @Transactional(readOnly = true)
    public Page<TourPackageDTO> findAll(Pageable pageable) {
        log.debug("Request to get all TourPackages");
        return tourPackageRepository.findAll(pageable).map(tourPackageMapper::toDto);
    }
