...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.travel.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.travel.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.travel.domain.User.class.getName());
