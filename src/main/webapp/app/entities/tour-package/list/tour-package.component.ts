...
export class TourPackageComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITourPackage): number => this.tourPackageService.getTourPackageIdentifier(item);
  ...
  delete(tourPackage: ITourPackage): void {
    const modalRef = this.modalService.open(TourPackageDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.tourPackage = tourPackage;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.tourPackages = dataFromBody;
  }
