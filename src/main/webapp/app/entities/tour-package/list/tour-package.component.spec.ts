...
import { sampleWithRequiredData } from '../tour-package.test-samples';
...
describe('TourPackage Management Component', () => {
  let comp: TourPackageComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TourPackageComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tourPackages?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tourPackageService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTourPackageIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTourPackageIdentifier).toHaveBeenCalledWith(entity);
