...
import { sampleWithRequiredData } from '../agency-service.test-samples';
...
describe('AgencyService Management Component', () => {
  let comp: AgencyServiceComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [AgencyServiceComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(AgencyServiceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.agencyServices?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to agencyServiceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAgencyServiceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAgencyServiceIdentifier).toHaveBeenCalledWith(entity);
