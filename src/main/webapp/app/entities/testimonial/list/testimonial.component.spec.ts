...
import { sampleWithRequiredData } from '../testimonial.test-samples';
...
describe('Testimonial Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TestimonialComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to testimonialService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTestimonialIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTestimonialIdentifier).toHaveBeenCalledWith(entity);
