...
import aboutUsResolve from './about-us-routing-resolve.service';

describe('AboutUs routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: AboutUsService;
  let resultAboutUs: IAboutUs | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IAboutUs returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        aboutUsResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAboutUs).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAboutUs>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
