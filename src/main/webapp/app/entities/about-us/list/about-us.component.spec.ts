...
import { sampleWithRequiredData } from '../about-us.test-samples';
import { AboutUsService } from '../service/about-us.service';

import { AboutUsComponent } from './about-us.component';
import SpyInstance = jest.SpyInstance;

describe('AboutUs Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.aboutuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to aboutUsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAboutUsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAboutUsIdentifier).toHaveBeenCalledWith(entity);
